...
_low_level_env_cfg = import_module("unitree_rl_lab.tasks.navigation_loco.robots.g1.29dof.low_level_env_cfg")
...
_DEFAULT_LOW_LEVEL_POLICY_PATH = str(_REPO_ROOT / "source" / "unitree_rl_lab" / "unitree_rl_lab" / "tasks" / "navigation_loco" / "models" / "policy.pt")
...
def make_low_level_inference_observations() -> LowLevelObservationsCfg.PolicyCfg:
    ...
    # deepcopy 继承低层训练 policy group 的 term 顺序/维度/func/params，逐字段对齐 TorchScript checkpoint 输入。
