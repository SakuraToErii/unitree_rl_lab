...
UNITREE_MODEL_DIR = "~/projects/unitree_model"  # Replace with the actual path to your unitree_model directory
UNITREE_ROS_DIR = "~/projects/unitree_ros"  # Replace with the actual path to your unitree_ros package
